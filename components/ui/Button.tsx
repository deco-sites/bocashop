...
const variants = {
  ...
  outline:
    "border h-9 px-3 rounded bg-base-100 text-primary border-primary hover:bg-primary-content active:opacity-90 disabled:opacity-75 focus:outline-none",
  ghost:
  ...
  icon:
    "h-9 w-9 bg-transparent text-primary hover:bg-primary-content active:opacity-90 disabled:opacity-75 focus:outline-none ",
};
...
const Button = forwardRef<HTMLButtonElement, Props>(({
  ...
  return (
    <Component
      {...props}
      className={`inline-flex items-center justify-center gap-2 cursor-pointer disabled:cursor-not-allowed transition-all duration-150 ease-in  font-button text-button ${styles} ${_class}`}
